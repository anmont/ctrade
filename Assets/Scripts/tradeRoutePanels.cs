...
public class tradeRoutePanels : MonoBehaviour
{
    ...
    public void createClick ()
    {
        ...
        else
        {
            ...
            refresh();
            globals.playerTradeRouteList[globals.playerTradeRouteList.FindIndex(a => a.tradeRouteId == uID)].jobList.Add(new routeTradeJobs(){ jobID = "0", tradeItemIndex = 4 });
            globals.playerTradeRouteList[globals.playerTradeRouteList.FindIndex(a => a.tradeRouteId == uID)].jobList.Add(new routeTradeJobs(){ jobID = "1", tradeItemIndex = 3 });
            globals.playerTradeRouteList[globals.playerTradeRouteList.FindIndex(a => a.tradeRouteId == uID)].jobList.Add(new routeTradeJobs(){ jobID = "2", tradeItemIndex = 6 });
